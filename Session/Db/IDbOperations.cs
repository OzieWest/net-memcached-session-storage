...
namespace MemcachedProviders.Session.Db
{
	public interface IDbOperations:IDisposable
	{
		...
		bool Update(string strSessionId, string strApplicationName, int iLockId, DateTime dExpires, byte[] objSessionItems, bool bLocked);
		...
		bool ResetItemTimeout(string strSessionId, string strApplicationName, int iTime);
	}
}
