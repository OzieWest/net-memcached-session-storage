...
namespace MemcachedProviders.Util
{
	...
	internal class CachingFilter:Stream
	{
		...
		public override long Length { get { return _objOriginalStream.Length; } }
		...
		public override void Flush() { _objOriginalStream.Flush(); }
		...
		public byte[] GetData() { return _objMemoryStream.ToArray(); }
